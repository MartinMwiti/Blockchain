...
print(web3.isConnected())  # check infura connection status
...
address = "0xd26114cd6EE289AccF82350c8d8487fedB8A0C07" #From OMG TOKEN on etherscan
...
#Sending transactions on Etherium
